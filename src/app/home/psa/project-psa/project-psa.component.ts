...
export class ProjectPSAComponent implements OnInit {
  ...
  constructor(private authService: AuthService, private formBuild: FormBuilder, private psaService: PsaService, private hrms: HrmsService, private toast: NotificationService) {
    //this.getIdcontract();
  }

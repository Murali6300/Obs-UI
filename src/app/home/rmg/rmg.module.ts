...
@NgModule({
  declarations: [RmgComponent, ApproveComponent, BenchEmployeesComponent, BookingRequestComponent, EmployeeexperienceComponent, ProposalsComponent, RejectComponent,RmgPipe, RmgreportsComponent, DeployedEmployeesComponent],
  imports: [
    CommonModule,
    RmgRoutingModule,
    FormsModule,
